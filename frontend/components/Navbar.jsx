      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/films" className="hover:text-red-500 transition-colors relative group">
              Films
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="/quests" className="hover:text-red-500 transition-colors relative group">
              Quests
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </div>
              ...
              <div className="relative">
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-48 glass-effect rounded-xl shadow-lg py-1 border border-red-900/20">
                    <Link href="/profile" className="block px-4 py-2 hover:bg-red-900/20 rounded-lg mx-1">
                      Profile
                    </Link>
                    <Link href="/watchlist" className="block px-4 py-2 hover:bg-red-900/20 rounded-lg mx-1">
                      Watchlist
                    </Link>
                    <button
      ...
      {isOpen && (
        <div className="md:hidden glass-effect rounded-b-2xl">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/" className="block px-3 py-2 rounded-md hover:bg-red-900/20" onClick={() => setIsOpen(false)}>
              Home
            </Link>
            <Link
              href="/films"
